<template>
    <div class="bg-[#1E1E1E] flex flex-col items-center">
        <div class="max-w-6xl w-[90%] md:w-[80%] flex align-top justify-between mx-auto py-10 text-center">
            <div class="flex flex-col flex-1">
                <h2 class="text-[#E0E0E0] text-2xl md:text-3xl font-medium tracking-wide">
                    {{ $t('Footer.header') }}
                </h2>
                <p class="text-[#B0B0B0] mt-4 text-sm leading-relaxed">
            ...
            <div class="flex flex-col flex-1">
                ...
                <div class="flex flex-wrap gap-4 justify-center mt-4">
                    ...
                    <a 
                        href="https://www.linkedin.com/in/david-hrbacek/" 
                        target="_blank" 
                        class="flex items-center gap-2 text-sm font-semibold text-[#B0B0B0] hover:text-primary-400 transition-colors duration-200"
                    >
                    ...
                    <button 
                        onclick="navigator.clipboard.writeText('hrbacekdavid.it@gmail.com'); alert('Email zkopírován!');"
                        class="cursor-pointer flex items-center gap-2 text-sm font-semibold text-[#B0B0B0] hover:text-primary-400 transition-colors duration-200"
                    >
        ...
        <div class="pb-6 text-center">
            <p class="text-sm text-gray-400 mb-2">© {{ new Date().getFullYear() }} David Hrbáček. {{ $t('Footer.rights') }}</p>
            <p class="text-xs text-gray-500">{{ $t('Footer.design') }}</p>
        </div>
    </div>
</template>
